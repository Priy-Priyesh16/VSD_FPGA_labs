...
HD_PWD='D:/VSD_FPGA_WORKSHOP/git_repo/VSD_FPGA_labs/project_files_vivado/project_1_up_counter_odin_test/project_1_up_counter_odin_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log up_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source up_counter.tcl
