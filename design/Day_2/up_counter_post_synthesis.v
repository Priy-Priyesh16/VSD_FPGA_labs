...
module up_counter (
    ...
    input \up_counter^rst ,
    input \up_counter^ena ,
    output \up_counter^counter_out~0 ,
    output \up_counter^counter_out~1 ,
    output \up_counter^counter_out~2 ,
    output \up_counter^counter_out~3 
);

    //Wires
    wire \up_counter^clk_output_0_0 ;
    wire \up_counter^rst_output_0_0 ;
    wire \up_counter^ena_output_0_0 ;
    ...
    wire \latch_up_counter^counter_out~0_FF_output_0_0 ;
    wire \latch_up_counter^counter_out~1_FF_output_0_0 ;
    wire \latch_up_counter^counter_out~2_FF_output_0_0 ;
    wire \latch_up_counter^counter_out~3_FF_output_0_0 ;
    wire \latch_up_counter^counter_out~0_FF_clock_0_0 ;
    wire \latch_up_counter^counter_out~3_FF_clock_0_0 ;
    wire \latch_up_counter^counter_out~1_FF_clock_0_0 ;
    wire \latch_up_counter^counter_out~2_FF_clock_0_0 ;
    ...
    wire \latch_up_counter^counter_out~0_FF_input_0_0 ;
    wire \latch_up_counter^counter_out~3_FF_input_0_0 ;
    wire \latch_up_counter^counter_out~2_FF_input_0_0 ;
    wire \latch_up_counter^counter_out~1_FF_input_0_0 ;
    ...
    wire \up_counter^counter_out~0_input_0_0 ;
    wire \lut_n37_input_0_0 ;
    wire \adder_up_counter^ADD~4-2[0]_input_0_0 ;
    wire \up_counter^counter_out~1_input_0_0 ;
    wire \lut_n32_input_0_2 ;
    wire \adder_up_counter^ADD~4-3[0]_input_0_0 ;
    wire \up_counter^counter_out~2_input_0_0 ;
    wire \lut_n27_input_0_4 ;
    wire \adder_up_counter^ADD~4-4[0]_input_0_0 ;
    wire \up_counter^counter_out~3_input_0_0 ;

    //IO assignments
    assign \up_counter^counter_out~0  = \up_counter^counter_out~0_input_0_0 ;
    assign \up_counter^counter_out~1  = \up_counter^counter_out~1_input_0_0 ;
    assign \up_counter^counter_out~2  = \up_counter^counter_out~2_input_0_0 ;
    assign \up_counter^counter_out~3  = \up_counter^counter_out~3_input_0_0 ;
    assign \up_counter^clk_output_0_0  = \up_counter^clk ;
    assign \up_counter^rst_output_0_0  = \up_counter^rst ;
    assign \up_counter^ena_output_0_0  = \up_counter^ena ;

    //Interconnect
    fpga_interconnect \routing_segment_up_counter^clk_output_0_0_to_latch_up_counter^counter_out~0_FF_clock_0_0  (
        .datain(\up_counter^clk_output_0_0 ),
        .dataout(\latch_up_counter^counter_out~0_FF_clock_0_0 )
    );

    fpga_interconnect \routing_segment_up_counter^clk_output_0_0_to_latch_up_counter^counter_out~3_FF_clock_0_0  (
        .datain(\up_counter^clk_output_0_0 ),
        .dataout(\latch_up_counter^counter_out~3_FF_clock_0_0 )
    );

    fpga_interconnect \routing_segment_up_counter^clk_output_0_0_to_latch_up_counter^counter_out~1_FF_clock_0_0  (
        .datain(\up_counter^clk_output_0_0 ),
        .dataout(\latch_up_counter^counter_out~1_FF_clock_0_0 )
    );

    fpga_interconnect \routing_segment_up_counter^clk_output_0_0_to_latch_up_counter^counter_out~2_FF_clock_0_0  (
        .datain(\up_counter^clk_output_0_0 ),
        .dataout(\latch_up_counter^counter_out~2_FF_clock_0_0 )
    );

    fpga_interconnect \routing_segment_up_counter^rst_output_0_0_to_lut_n22_input_0_1  (
        .datain(\up_counter^rst_output_0_0 ),
        .dataout(\lut_n22_input_0_1 )
    );

    fpga_interconnect \routing_segment_up_counter^rst_output_0_0_to_lut_n27_input_0_2  (
        .datain(\up_counter^rst_output_0_0 ),
        .dataout(\lut_n27_input_0_2 )
    );

    fpga_interconnect \routing_segment_up_counter^rst_output_0_0_to_lut_n37_input_0_2  (
        .datain(\up_counter^rst_output_0_0 ),
        .dataout(\lut_n37_input_0_2 )
    );

    fpga_interconnect \routing_segment_up_counter^rst_output_0_0_to_lut_n32_input_0_4  (
        .datain(\up_counter^rst_output_0_0 ),
        .dataout(\lut_n32_input_0_4 )
    );

    fpga_interconnect \routing_segment_up_counter^ena_output_0_0_to_lut_n22_input_0_2  (
        .datain(\up_counter^ena_output_0_0 ),
        .dataout(\lut_n22_input_0_2 )
    );

    fpga_interconnect \routing_segment_up_counter^ena_output_0_0_to_lut_n27_input_0_0  (
        .datain(\up_counter^ena_output_0_0 ),
        .dataout(\lut_n27_input_0_0 )
    );

    fpga_interconnect \routing_segment_up_counter^ena_output_0_0_to_lut_n37_input_0_4  (
        .datain(\up_counter^ena_output_0_0 ),
        .dataout(\lut_n37_input_0_4 )
    );

    fpga_interconnect \routing_segment_up_counter^ena_output_0_0_to_lut_n32_input_0_0  (
        .datain(\up_counter^ena_output_0_0 ),
        .dataout(\lut_n32_input_0_0 )
    );

    fpga_interconnect \routing_segment_lut_n22_output_0_0_to_latch_up_counter^counter_out~0_FF_input_0_0  (
        .datain(\lut_n22_output_0_0 ),
        .dataout(\latch_up_counter^counter_out~0_FF_input_0_0 )
    );

    fpga_interconnect \routing_segment_lut_n27_output_0_0_to_latch_up_counter^counter_out~3_FF_input_0_0  (
        .datain(\lut_n27_output_0_0 ),
        .dataout(\latch_up_counter^counter_out~3_FF_input_0_0 )
    );

    fpga_interconnect \routing_segment_lut_n32_output_0_0_to_latch_up_counter^counter_out~2_FF_input_0_0  (
        .datain(\lut_n32_output_0_0 ),
        .dataout(\latch_up_counter^counter_out~2_FF_input_0_0 )
    );

    fpga_interconnect \routing_segment_lut_n37_output_0_0_to_latch_up_counter^counter_out~1_FF_input_0_0  (
        .datain(\lut_n37_output_0_0 ),
        .dataout(\latch_up_counter^counter_out~1_FF_input_0_0 )
    );
    ...
    fpga_interconnect \routing_segment_latch_up_counter^counter_out~0_FF_output_0_0_to_lut_n22_input_0_4  (
        .datain(\latch_up_counter^counter_out~0_FF_output_0_0 ),
        .dataout(\lut_n22_input_0_4 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~0_FF_output_0_0_to_adder_up_counter^ADD~4-1[0]_input_0_0  (
        .datain(\latch_up_counter^counter_out~0_FF_output_0_0 ),
        .dataout(\adder_up_counter^ADD~4-1[0]_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~0_FF_output_0_0_to_up_counter^counter_out~0_input_0_0  (
        .datain(\latch_up_counter^counter_out~0_FF_output_0_0 ),
        .dataout(\up_counter^counter_out~0_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~1_FF_output_0_0_to_lut_n37_input_0_0  (
        .datain(\latch_up_counter^counter_out~1_FF_output_0_0 ),
        .dataout(\lut_n37_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~1_FF_output_0_0_to_adder_up_counter^ADD~4-2[0]_input_0_0  (
        .datain(\latch_up_counter^counter_out~1_FF_output_0_0 ),
        .dataout(\adder_up_counter^ADD~4-2[0]_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~1_FF_output_0_0_to_up_counter^counter_out~1_input_0_0  (
        .datain(\latch_up_counter^counter_out~1_FF_output_0_0 ),
        .dataout(\up_counter^counter_out~1_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~2_FF_output_0_0_to_lut_n32_input_0_2  (
        .datain(\latch_up_counter^counter_out~2_FF_output_0_0 ),
        .dataout(\lut_n32_input_0_2 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~2_FF_output_0_0_to_adder_up_counter^ADD~4-3[0]_input_0_0  (
        .datain(\latch_up_counter^counter_out~2_FF_output_0_0 ),
        .dataout(\adder_up_counter^ADD~4-3[0]_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~2_FF_output_0_0_to_up_counter^counter_out~2_input_0_0  (
        .datain(\latch_up_counter^counter_out~2_FF_output_0_0 ),
        .dataout(\up_counter^counter_out~2_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~3_FF_output_0_0_to_lut_n27_input_0_4  (
        .datain(\latch_up_counter^counter_out~3_FF_output_0_0 ),
        .dataout(\lut_n27_input_0_4 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~3_FF_output_0_0_to_adder_up_counter^ADD~4-4[0]_input_0_0  (
        .datain(\latch_up_counter^counter_out~3_FF_output_0_0 ),
        .dataout(\adder_up_counter^ADD~4-4[0]_input_0_0 )
    );

    fpga_interconnect \routing_segment_latch_up_counter^counter_out~3_FF_output_0_0_to_up_counter^counter_out~3_input_0_0  (
        .datain(\latch_up_counter^counter_out~3_FF_output_0_0 ),
        .dataout(\up_counter^counter_out~3_input_0_0 )
    );
    ...
    DFF #(
        .INITIAL_VALUE(1'b0)
    ) \latch_up_counter^counter_out~0_FF  (
        .D(\latch_up_counter^counter_out~0_FF_input_0_0 ), 
        .Q(\latch_up_counter^counter_out~0_FF_output_0_0 ), 
        .clock(\latch_up_counter^counter_out~0_FF_clock_0_0 )
    );
    LUT_K #(
        .K(5),
    ...
    DFF #(
        .INITIAL_VALUE(1'b0)
    ) \latch_up_counter^counter_out~3_FF  (
        .D(\latch_up_counter^counter_out~3_FF_input_0_0 ), 
        .Q(\latch_up_counter^counter_out~3_FF_output_0_0 ), 
        .clock(\latch_up_counter^counter_out~3_FF_clock_0_0 )
    );
    LUT_K #(
        .K(5),
    ...
    DFF #(
        .INITIAL_VALUE(1'b0)
    ) \latch_up_counter^counter_out~1_FF  (
        .D(\latch_up_counter^counter_out~1_FF_input_0_0 ), 
        .Q(\latch_up_counter^counter_out~1_FF_output_0_0 ), 
        .clock(\latch_up_counter^counter_out~1_FF_clock_0_0 )
    );
    LUT_K #(
        .K(5),
    ...
    DFF #(
        .INITIAL_VALUE(1'b0)
    ) \latch_up_counter^counter_out~2_FF  (
        .D(\latch_up_counter^counter_out~2_FF_input_0_0 ), 
        .Q(\latch_up_counter^counter_out~2_FF_output_0_0 ), 
        .clock(\latch_up_counter^counter_out~2_FF_clock_0_0 )
    );
    adder #(
        .WIDTH(1)
